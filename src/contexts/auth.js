...
export const AuthProvider = ({children}) => {
    ...
    const login = async (usuario, senha) => {
        ...
        api.defaults.headers.Authorization = `Banco ${token}` //Alterar banco para o nome do banco/api
    ...
    useEffect(() => {
        ...
        if(usuarioRecuperado && tokenRecuperado) {
            ...
            api.defaults.headers.Authorization = `Banco ${tokenRecuperado}` //Alterar banco para o nome do banco/api
        }
